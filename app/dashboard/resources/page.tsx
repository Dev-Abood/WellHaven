		...
		<div className="container p-4 md:p-6">
			<div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
				<div>
					<div className="flex items-baseline space-x-5">
						{" "}
						{/* Changed to items-baseline */}
						<Button
							asChild
							size="icon"
							className="bg-teal-600 hover:bg-teal-700 text-white rounded-full w-10 h-10"
						>
							<Link href="/dashboard">
					...
					<p className="text-gray-600">
						Articles, exercises, and tools to support your mental health
					</p>
				</div>
				...
				<TabsContent value="all">
					<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
						...
						<Card className="md:col-span-3">
							<CardHeader>
								<div className="flex justify-between items-start">
									<div>
										<Badge className="mb-2 bg-teal-100 text-teal-800 hover:bg-teal-100">
											Featured
										</Badge>
							...
							<CardContent>
								<p className="text-gray-600">
									This comprehensive guide explains what anxiety is, common
									triggers, and effective strategies to manage anxiety symptoms
									in your daily life.
								</p>
							</CardContent>
							<CardFooter>
						...
						<Card>
							...
							<CardContent>
								<p className="text-gray-600">
									Learn the fundamentals of mindfulness and how to incorporate
									it into your daily routine.
								</p>
							</CardContent>
							<CardFooter>
								<Button variant="outline" asChild className="w-full">
									<Link href="/dashboard/resources/mindfulness-basics">
										Read Article
									</Link>
								</Button>
							</CardFooter>
						...
						<Card>
							...
							<CardContent>
								<p className="text-gray-600">
									A quick breathing exercise to help reduce stress and anxiety
									in the moment.
								</p>
							</CardContent>
							<CardFooter>
						...
						<Card>
							...
							<CardContent>
								<p className="text-gray-600">
									Learn practical techniques to manage stress in your daily
									life.
								</p>
							</CardContent>
							<CardFooter>
								<Button variant="outline" asChild className="w-full">
									<Link href="/dashboard/resources/stress-management-video">
										Watch Video
									</Link>
								</Button>
							</CardFooter>
						...
						<Card>
							...
							<CardContent>
								<p className="text-gray-600">
									A calming meditation to help you relax and fall asleep more
									easily.
								</p>
							</CardContent>
							<CardFooter>
								<Button variant="outline" asChild className="w-full">
									<Link href="/dashboard/resources/sleep-meditation">
										Listen Now
									</Link>
								</Button>
							</CardFooter>
						...
						<Card>
							...
							<CardContent>
								<p className="text-gray-600">
									Tips for developing and maintaining healthy relationships in
									your life.
								</p>
							</CardContent>
							<CardFooter>
								<Button variant="outline" asChild className="w-full">
									<Link href="/dashboard/resources/healthy-relationships">
										Read Article
									</Link>
								</Button>
							</CardFooter>
						...
						<Card>
							...
							<CardContent>
								<p className="text-gray-600">
									A step-by-step guide to relax your body and reduce physical
									tension.
								</p>
							</CardContent>
							<CardFooter>
								<Button variant="outline" asChild className="w-full">
									<Link href="/dashboard/resources/muscle-relaxation">
										Start Exercise
									</Link>
								</Button>
							</CardFooter>
			...
			<div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
				{[
					...
					>
						<Link
							href={`/dashboard/resources/category/${category.name.toLowerCase()}`}
						>
			...
			<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
				<Card>
					...
					<CardContent>
						<p className="text-gray-600">
							Learn how to identify and manage common triggers that can cause
							anxiety.
						</p>
					</CardContent>
					<CardFooter>
						<Button variant="outline" asChild className="w-full">
							<Link href="/dashboard/resources/anxiety-triggers">
								Continue Reading
							</Link>
						</Button>
					</CardFooter>
				...
				<Card>
					...
					<CardContent>
						<p className="text-gray-600">
							A guided meditation to help you find calm during stressful
							moments.
						</p>
					</CardContent>
					<CardFooter>
						<Button variant="outline" asChild className="w-full">
							<Link href="/dashboard/resources/calming-meditation">
								Listen Again
							</Link>
						</Button>
					</CardFooter>
